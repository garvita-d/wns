      ...
      <div className="w-full max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <AnimatePresence mode="popLayout">
          ...
          >
            ...
            <div className="mb-6 p-2 rounded-lg bg-white dark:bg-white">
              <Image
                src={image}
            ...
            {/* Testimonial text with theme support */}
            <p className="m-0 text-center text-lg sm:text-xl md:text-2xl lg:text-3xl text-gray-700 dark:text-gray-300 font-medium tracking-tight">
              "{text}"
            </p>
          </motion.div>

          {/* Pagination dots with theme support */}
